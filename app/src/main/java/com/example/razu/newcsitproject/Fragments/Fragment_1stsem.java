...
public class Fragment_1stsem extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_1stems, container, false);
    ...
    public void getfiles_data(){
        ...
        Call<Model_syllabus_main> mquestion = mapi.mgetnotes(semester);
        mquestion.enqueue(new Callback<Model_syllabus_main>() {
            ...
            public void onResponse(Call<Model_syllabus_main> call, Response<Model_syllabus_main> response) {
                ...
                mrecycler.setAdapter(new Recyclerview_downloadfiles(mlistview,getContext(),"notes"));
            }
