...
import com.example.razu.newcsitproject.Fragments.Fragment_fri;
import com.example.razu.newcsitproject.Fragments.Fragment_mon;
import com.example.razu.newcsitproject.Fragments.Fragment_sun;
import com.example.razu.newcsitproject.Fragments.Fragment_thur;
import com.example.razu.newcsitproject.Fragments.Fragment_ue;
import com.example.razu.newcsitproject.Fragments.Fragment_wed;
...
public class Csit_colleges extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_csitcolleges);
    ...
    tabLayout = (TabLayout) findViewById(R.id.tabs);
        ...
        fgs.setOnClickListener(new View.OnClickListener() {
            @Override
           public void onClick(View view) {
                //Intent intesns = new Intent(Csit_colleges.this,Eventadds.class);
    ...
    private void setupViewPager(ViewPager viewPager) {
        Csit_colleges.ViewPagerAdapter adapter = new Csit_colleges.ViewPagerAdapter(getSupportFragmentManager());
    ...
    public void alertdialogue_addroutine(){
        ...
        starttimesss.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                timepickerdialoges = new TimePickerDialog(Csit_colleges.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        endtimesss.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                timepickerdialoge = new TimePickerDialog(Csit_colleges.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker timePicker, int ihour, int i1minute) {
